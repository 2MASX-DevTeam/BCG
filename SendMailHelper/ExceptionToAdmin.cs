...
{
    public class ExceptionToAdmin
    {
        /* Add the Creddentials- use your own email id and password */
        private string emailFrom = ""; //Replace this with your own correct Gmail Address
        private string emailTo =  ""; //Replace this with the Email Address to whom you want to send the mail
